...
function ShowAllcomment({
  ...
  useEffect(() => {
    const renderFirst = async () => {
      ...
      if (memberData.collect.length) {
        const collectCount = memberData.collect.length;
  ...
  return (
    <>
      <div className="showAllcommentContainer">
        <div
          className="closeAllcomment"
          onClick={() => {
            setclickShowAllComment(false);
          }}
        >
          <CgClose style={{ width: "30px", height: "30px", color: "#FFF" }} />
        </div>
        <div className="showAllcommentContainer__box">
          <div className="showAllcommentContainer__img">
            {totalimgCount == 1 || currentImgCount == 0 ? null : (
              <div className="showAllcommentContainer__picture__Leftbtn">
                <BiChevronLeftCircle
                  style={{
                    width: "30px",
                    height: "30px",
            ...
            currentImgCount + 1 == totalimgCount ? null : (
              <div className="showAllcommentContainer__picture__Rightbtn">
          ...
          <div className="showAllcommentContainer__information">
            <div className="showAllcommentContainer__name">
              <div className="showAllcommentContainer__name__title">
                <div className="showAllcommentContainer__name__personImagebox">
                  <div
                    className="showAllcommentContainer__name__personImage"
                    style={{ backgroundImage: `url(${posterImg})` }}
                  ></div>
                  <div className="showAllcommentContainer__name__username">
                    {post.username}
                  </div>
                </div>
                <div
                  className="showAllcommentContainer__deletePost"
            ...
            <div className="showAllcommentContainer__content__main">
              {post.caption === "" ? null : (
                <div className="showAllcommentContainer__content">
                  <div className="showAllcommentContainer__content__authBox">
                    <div
                      className="showAllcommentContainer__authImg"
                      style={{ backgroundImage: `url(${posterImg})` }}
                    ></div>
                  </div>
                  <div className="showAllcommentContainer__authBox">
                    <div className="showAllcommentContainer__auth">
                      {post.username}
                    </div>
                    <span className="showAllcommentContainer__text">
                      {post.caption}
                    </span>
                  </div>
                </div>
              ...
              <div className="showAllcommentContainer__msg__box">
                {allComment
                  ? allComment.map(({ userImg, username, message }, index) => {
                      return (
                        <div
                          className="showAllcommentContainer__msg"
                          key={index}
                        >
                          <div className="showAllcommentContainer__msg__main">
                            <div className="showAllcommentContainer__msg__userBox">
                              <div
                                className="showAllcommentContainer__msg__userImg"
                                style={{ backgroundImage: `url(${userImg})` }}
                              ></div>
                              <div className="showAllcommentContainer__msg__msg">
                                <div className="showAllcommentContainer__msg__name">
                                  {username}
                                </div>
                                {message}
                              </div>
            ...
            <div className="showAllcommentContainer__icon">
              <div className="showAllcommentContainer__icon__left">
                <div
                  className="showAllcommentContainer__icon__like"
                ...
                <div
                  className="showAllcommentContainer__icon__msg"
              ...
              <div
                className="showAllcommentContainer__icon__mark"
                onClick={handleMark}
              >
                {clickMark ? (
            ...
            <div>
              {likeCount > 1 ? (
                <div className="showAllcommentContainer__like">
                  <div className="showAllcommentContainer__like_name">
                    {firstLikeUserName}
                  </div>
                  <div className="showAllcommentContainer__like__count">
                    和其他{likeCount - 1}人都說讚
                  </div>
                </div>
              ) : null}
              {likeCount == 1 ? (
            ...
            <div className="showAllcommentContainer__input">
              <input
                className="showAllcommentContainer__msg__input"
                type="text"
                placeholder="留言..."
                ref={composingRef}
